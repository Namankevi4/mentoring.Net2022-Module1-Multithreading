...
namespace MultiThreading.Task3.MatrixMultiplier
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            byte matrixSize = byte.Parse(Console.ReadLine() ?? throw new InvalidOperationException());
        ...
        private static void CreateAndProcessMatrices(byte sizeOfMatrix)
        {
            ...
            IMatrix resultMatrixSync = new MatricesMultiplier().Multiply(firstMatrix, secondMatrix);
            ...
            secondMatrix.Print();
            Console.WriteLine("resultMatrix sync:");
            resultMatrixSync.Print();
